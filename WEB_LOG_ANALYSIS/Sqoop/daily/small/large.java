// ORM class for table 'large'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Apr 29 21:15:06 UTC 2017
...
public class large extends SqoopRecord  implements DBWritable, Writable {
  ...
  public large with_date(String date) {
    this.date = date;
    return this;
  }
  private String time;
  ...
  public large with_time(String time) {
    this.time = time;
    return this;
  }
  ...
  public void set_IP_ADD(String IP_ADD) {
    this.IP_ADD = IP_ADD;
  }
  public large with_IP_ADD(String IP_ADD) {
    this.IP_ADD = IP_ADD;
    return this;
  }
  ...
  public large with_cs_method(String cs_method) {
    this.cs_method = cs_method;
    return this;
  }
  ...
  public large with_cs_uri_stem(String cs_uri_stem) {
    this.cs_uri_stem = cs_uri_stem;
    return this;
  }
  ...
  public large with_cs_uri_query(String cs_uri_query) {
    this.cs_uri_query = cs_uri_query;
    return this;
  }
  ...
  public large with_s_port(Integer s_port) {
    this.s_port = s_port;
    return this;
  }
  ...
  public large with_cs_username(String cs_username) {
    this.cs_username = cs_username;
    return this;
  }
  private String c_ip;
  ...
  public large with_c_ip(String c_ip) {
    this.c_ip = c_ip;
    return this;
  }
  ...
  public large with_cs_user_agent(String cs_user_agent) {
    this.cs_user_agent = cs_user_agent;
    return this;
  }
  ...
  public large with_sc_status(String sc_status) {
    this.sc_status = sc_status;
    return this;
  }
  ...
  public large with_sc_substatus(String sc_substatus) {
    this.sc_substatus = sc_substatus;
    return this;
  }
  ...
  public large with_sc_win_status(String sc_win_status) {
    this.sc_win_status = sc_win_status;
    return this;
  }
  ...
  public large with_time_taken(String time_taken) {
    this.time_taken = time_taken;
    return this;
  }
  public boolean equals(Object o) {
    ...
    equal = equal && (this.IP_ADD == null ? that.IP_ADD == null : this.IP_ADD.equals(that.IP_ADD));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.IP_ADD = JdbcWritableBridge.readString(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(IP_ADD, 3 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.IP_ADD = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.cs_method = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.IP_ADD) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, IP_ADD);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(IP_ADD==null?"null":IP_ADD, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.IP_ADD = null; } else {
      this.IP_ADD = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    large o = (large) super.clone();
    return o;
  }

  public void clone0(large o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("IP_ADD", this.IP_ADD);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("IP_ADD".equals(__fieldName)) {
      this.IP_ADD = (String) __fieldVal;
    }
